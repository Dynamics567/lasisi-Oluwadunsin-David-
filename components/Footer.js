                                        ...
                                        <div className="row">
                                            <div className="col-lg-4">
                                                <div className="footer-widget footer-widget__about">
                                                    <a className="footer-widget__logo" href="/"><img
                                                        src="/assets/images/logo-1-1.png" width="105"
                                                        alt="Awesome Image"/></a>
                                                    <p>Afrilands mission is to provide excellent educational content for Africans, anywhere. </p>
                                                    <p><a href="mailto:info@afriland">mailto:info@afriland</a> <br/>
                                                        <a href="tel:+2348051544949">+2348051544949, +2348027855262</a></p>
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-lg-4">
                                                <div className="footer-widget footer-widget__subscribe">
                                                    <h3 className="footer-widget__title">Have a question?</h3>
                                                    <button type="submit"
                                                                    className="thm-btn footer-widget__mc-btn">Chat Us
                                                                Now
                                                            </button>
                                ...
                                <div className="site-footer__bottom">
                                    <div className="container">
                                        <div className="inner-container">
                                            ...
                                            <p>© copyright 2020 by myafrilearn.com</p>
                                        </div>
